    ...
    <DashboardLayout type="agent">
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
          <StatCard title={t("salesToday")} value="3" icon={ShoppingCart} trend={{ value: 50, positive: true }} subtitle={t("vsYesterday")} />
          <StatCard title={t("thisWeek")} value="12" icon={TrendingUp} trend={{ value: 20, positive: true }} subtitle={t("vsLastWeek")} />
          <StatCard title={t("thisMonth")} value="38" icon={Calendar} trend={{ value: 15, positive: true }} subtitle={t("vsLastMonth")} className="col-span-2 sm:col-span-1" />
        </div>
