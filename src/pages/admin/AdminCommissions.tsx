...
const defaultRates = [
  { type: "airport", label: "Airport Agents", rate: 4 },
  { type: "taxi", label: "Taxi Drivers", rate: 4 },
  { type: "hotel", label: "Hotel Staff", rate: 3 },
  { type: "tour_guide", label: "Tour Guides", rate: 5 },
  { type: "affiliate", label: "Affiliates", rate: 4 },
];
    ...
    <DashboardLayout type="admin">
      <div className="space-y-6 max-w-2xl">
        ...
        <div className="rounded-lg border bg-card shadow-card p-6">
          <h3 className="font-semibold mb-1">Default Commission Rates</h3>
          <p className="text-sm text-muted-foreground mb-6">Set the default commission per sale for each agent type.</p>
              ...
              <div key={r.type} className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Input
                    type="number"
                    value={r.rate}
                    onChange={(e) => updateRate(r.type, Number(e.target.value))}
                    className="w-24"
                    min={0}
                    step={0.5}
                  />
          ...
          <Button
            className="mt-6 gradient-primary border-0 text-primary-foreground hover:opacity-90"
            onClick={() => toast.success("Commission rates updated")}
          >
            Save Rates
          </Button>
        </div>
        ...
        <div className="rounded-lg border bg-card shadow-card p-6">
          <h3 className="font-semibold mb-1">Product: Turkey Unlimited eSIM</h3>
